...
In the paper, Dr. Merton describes an algorithm that constructs a portfolio from a list of identified securities with the <ins>lowest variance in returns for a given level of expected returns</ins>, given historical returns data for the stocks.
...
If the entire S&P 100 is used as input with data from 1/1/2011 to 12/31/2019, this is the minimum-variance allocation to achieve about 25% annual returns:
...
The Merton portfolio saw an alpha factor of over 20% and a beta of 7%, handily surpassing the equal weight portfolio with 3.5% and 0.97% respectively:
</br>
